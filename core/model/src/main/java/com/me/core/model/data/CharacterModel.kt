package com.me.core.model.data

import android.annotation.SuppressLint
import android.content.Context
import android.os.Parcelable
import androidx.annotation.ColorRes
import com.me.model.R
import com.me.utils.adapter.ItemViewable
import com.me.utils.extensions.asResourceColor
import com.me.utils.extensions.parseFullDate
...
data class CharacterModel(
    ...
    enum class Status(
        val id: String,
        @SuppressLint("SupportAnnotationUsage") @ColorRes val color: (Context) -> Int
    ) {
        ALIVE(
            "Alive",
            { context ->
